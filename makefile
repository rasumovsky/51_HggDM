...
bin/%	: obj/%.o obj/statistics.o obj/statisticsDict.o obj/RooBernsteinM.o obj/RooBernsteinMDict.o obj/CommonFunc.o obj/DMTree.o obj/BRXSReader.o obj/ESSReader.o obj/ResReader.o obj/DMEvtSelect.o obj/DMMassPoints.o
